<template>
    <div id="main">
        ...
        <div class="list">
            <router-link class="on" to="/recipe">菜谱首页<i></i><b></b></router-link>
            <a href="#">分类<i></i><b></b></a>
            <a href="#">菜单<i></i><b></b></a>
            <a href="#">排行<i></i><b></b></a>
                ...
                <div class="recipe-list-a">
                    <div class="recipe-list-b">
                        <div class="title_wrap">
                            ...
                            <a title="全部分类" class="" href="#">全部分类</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="big-list">
                <ul class="on">
                    <li v-for="item of list" :key="item.recipe_id">
                        <router-link :title="item.recipe_name" :to="`/details/${item.recipe_id}`" target="_blank">
                            <i>
                                <img alt="" class="imgLoad" :src="item.recipe_pic" style="display: block;">
                            </i>
